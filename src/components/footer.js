...
function Footer(props) {        
    return (
        <div className="text-center py-10 max-w-4xl mx-auto">
            ...
            <p className="px-3 text-gray-300 my-2 text-sm">ZwiftIRL is neither endorsed by nor affiliated with <a href="https://zwift.com" target="_blank" className="font-semibold text-white">Zwift</a>.</p>
        </div>
    );
}
