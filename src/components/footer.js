    ...
    return (
        <div className="text-center py-10 max-w-4xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto text-left text-gray-300 mb-6 px-3">
                <p className="my-3">Thank you so much for all the support for ZwiftIrl, it's been great seeing what you've made! In the 5 says since lauch you created over 34,000 images 🤯</p>
